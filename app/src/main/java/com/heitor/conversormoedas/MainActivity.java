package com.heitor.conversormoedas;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.mViewHolder.buttonClear = this.findViewById(R.id.button_clear);
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.button_calculate) {
            ...
            if ("".equals(value)) {
                ...
                // Converte valores
                this.mViewHolder.textDollar.setText(String.format("%.2f", real / 5.35));
                this.mViewHolder.textEuro.setText(String.format("%.2f", real / 5.63));
            }
        }
